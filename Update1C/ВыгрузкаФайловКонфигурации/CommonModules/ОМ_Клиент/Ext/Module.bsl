...
&НаКлиенте
Процедура УдалитьВременныеФайлыНаКлиенте() Экспорт
	
	Каталог 				= ОМ_Парсинг.КаталогВременныхФайловПарсера();
	НачатьУдалениеФайлов(Новый ОписаниеОповещения("УдалитьВременныеФайлыНаКлиентеЗавершение", ЭтотОбъект), Каталог, "*");
	
КонецПроцедуры

&НаКлиенте
Процедура УдалитьВременныеФайлыНаКлиентеЗавершение(ДополнительныеПараметры) Экспорт
КонецПроцедуры
